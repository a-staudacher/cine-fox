...
/*    @Autowired
    ...
    public at.fh.ima.swengs.moviedbv3.dto.PersonDTO create(at.fh.ima.swengs.moviedbv3.dto.PersonDTO dto) {
        at.fh.ima.swengs.moviedbv3.model.Person entity = new at.fh.ima.swengs.moviedbv3.model.Person();
        mapDtoToEntity(dto, entity);
        mapEntityToDto(actorService.save(entity), dto);
        return dto;
    }
