...
public class UserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        try {
            at.fh.ima.swengs.cineFoxDB.model.User user = userRepository.findByUsername(username);
    ...
    public void initUsers() {
        if (userRepository.count() == 0) {
            at.fh.ima.swengs.cineFoxDB.model.User admin = new at.fh.ima.swengs.cineFoxDB.model.User();
            admin.setUsername("admin");
            admin.setPassword(encoder.encode("12345"));
            admin.setAdmin(true);
            userRepository.save(admin);

            at.fh.ima.swengs.cineFoxDB.model.User tester = new at.fh.ima.swengs.cineFoxDB.model.User();
